    ...
    <body class="min-h-screen bg-blue-300">
        ...
        <main class="min-h-screen flex justify-center items-center p-9 "> 
            <form method="post" class="max-w-md w-full space-y-2 bg-green-400 p-9 rounded-lg shadow-2xl">
                <h1 class="text-lg text-center underline text-blue-700 font-bold mb-3">Add Marks</h1>
                ...
                <label class="text-md text-blue-700 font-bold block">Formative Assessment Marks/50</label>
                <input type="number" name="Formative_Assessment" 
                class="w-full py-2 rounded-lg shadow-lg bg-green-200 text-green-500 focus:ring-2 focus:outline-green-400"> <br>

                <label class="text-md text-blue-700 font-bold block">Summative Assessment Marks/50</label>
                ...
                <div class="flex justify-between mb-4">
                    ...
                    <a href="greetingUser.php" class="bg-red-500 py-2 px-5 text-white rounded-lg shadow-xl hover:bg-red-600 transition duration-200">Back</a>
                </div>
                <?php if (!empty($error)): ?>
